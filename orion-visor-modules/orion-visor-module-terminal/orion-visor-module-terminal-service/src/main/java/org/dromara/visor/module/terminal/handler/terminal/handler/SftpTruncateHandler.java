...
@Slf4j
@Component
public class SftpTruncateHandler extends AbstractTerminalHandler<ISftpTerminalSender, SftpBaseRequest> {
    ...
    public void handle(TerminalChannelProps props, ISftpTerminalSender sender, SftpBaseRequest payload) {
        ...
        // 返回结果
        sender.sendTruncateResult(ex == null, this.getErrorMessage(ex));
        // 保存操作日志
