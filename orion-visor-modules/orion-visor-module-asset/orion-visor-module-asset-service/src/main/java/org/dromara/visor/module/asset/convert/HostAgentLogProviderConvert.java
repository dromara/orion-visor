 ...
 */
@Mapper
public interface HostAgentLogProviderConvert {

    HostAgentLogProviderConvert MAPPER = Mappers.getMapper(HostAgentLogProviderConvert.class);

    HostAgentLogDTO to(HostAgentLogDO domain);
