 ...
 */
public interface MonitorMetricsCacheKeyDefine {

    CacheKeyDefine MONITOR_METRICS = new CacheKeyBuilder()
            .key("monitor:metrics:list")
            .desc("监控指标")
            .type(MonitorMetricsCacheDTO.class)
