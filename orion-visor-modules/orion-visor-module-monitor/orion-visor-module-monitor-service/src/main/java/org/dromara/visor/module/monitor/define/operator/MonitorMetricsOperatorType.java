 ...
 */
@Module("monitor:monitor-metrics")
public class MonitorMetricsOperatorType extends InitializingOperatorTypes {

    public static final String CREATE = "monitor-metrics:create";

    public static final String UPDATE = "monitor-metrics:update";

    public static final String DELETE = "monitor-metrics:delete";
